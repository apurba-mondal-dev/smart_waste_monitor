...
export const LocationCard = ({ location }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition duration-200 flex flex-col justify-between overflow-hidden">
      {/* Top section */}
      <div className="p-6">
      ...
      {/* Footer section */}
      <div className="bg-gray-50 px-6 py-4 border-t border-gray-150 flex flex-col space-y-3">
        ...
        <div className="flex justify-between space-x-2">
          <Link
            ...
            className="flex-1 inline-flex items-center justify-center space-x-1.5 px-3 py-2 bg-white hover:bg-gray-100 border border-gray-300 rounded-lg text-xs font-semibold text-gray-700 transition"
          >
